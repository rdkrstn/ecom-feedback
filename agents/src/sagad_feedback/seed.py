...
from .schemas import FeedbackReviewInput


SAMPLE_REVIEW_INPUT = FeedbackReviewInput(
...
- How long did shipping take?""",
    ...
    product_page_copy=(
        "Our compression leggings are comfortable, stylish, and perfect for workouts or everyday wear. "
        "Designed to move with you and support your active lifestyle."
    ),
    main_business_concern=(
        "Support keeps answering the same sizing and shipping questions, and UGC videos are not "
...
def get_sample_payload() -> dict:
    return SAMPLE_REVIEW_INPUT.model_dump(mode="json")
